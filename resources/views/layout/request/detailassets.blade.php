                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6 col-sm-6 m-b-20">
                            ...
                            <h2 class="text-uppercase">Assets #</h2>
                        </div>
                        <div class="col-6 col-sm-6 text-right">
                            @if ($asset->status == 'AVAILABLE')
                                <button class="btn btn-white" id="show-form">UNAVAILABLE</button>
                            @endif
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 m-b-20">
                            <table cellspacing="2" border="0" width="95%" cellpadding="3" class="clientTicket">
                                ...
                                <tr>
                                    ...
                                    <td><strong>:</strong></td>
                                    <td>{{ $asset->created_at->format('d / m / Y , g.i A') }}</td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-4 col-sm-4 text-center">
                            <table cellspacing="2" border="0" width="95%" cellpadding="3" class="clientTicket">
                                ...
                                <tr>
                                    <td><img src="{{ asset('storage/Assets/' . $asset->file) }}" alt=""
                                            style="width: 250px; height: 250px;"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <form action="{{ route('statusup') }}" method="POST">
                        <div class="card-body">
                        </div>
                        @csrf
                        @method('put')
                        <div class="row formtype" style="display: none;" id="notes">
                            ...
                            <div class="col-md-12">
                                <div class="alert alert-danger" role="alert">
                                    Set location and area for unvaible assets
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="usr" name="area" placeholder="Area">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
