@section('content')
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title mt-5">Assets</h3>
            </div>
        </div>
    </div>
    <div class="row ">
                ...
                <div class="row formtype">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="sel1" name="type">
                                <option selected="selected" value="{{ $assets['id'] == 1}}">CCTV</option>
                                <option value="{{ $assets['type'] == 0}}">Hardware</option>
                                <option value="">Laptop</option>
                                <option value="3">Orion.Nodes</option>
                                <option value="4">Orion.VIM.Hosts</option>
                                <option value="5">Orion.VIM.VCenters</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control" id="usr" name="model" value="{{ $assets['model'] }}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            @enderror
                            <textarea class="form-control" rows="5" id="comment" name="serial">{{ $assets['serial']}}</textarea>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="form-group">
